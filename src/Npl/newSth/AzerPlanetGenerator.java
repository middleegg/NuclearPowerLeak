...
public class AzerPlanetGenerator extends PlanetGenerator{
    Color c1 = Color.valueOf("91D479"), c2 = Color.valueOf("C8E7AF"),c3 =NuColor.SailConColor,c4 = NuColor.SailColor;
    Block[][] arr = {
    ...
    public void getColor(Vec3 position, Color out){
        float depth = Simplex.noise3d(321, 12, 0.42f,8.7f, position.x, position.y, position.z) / 2f;
